    ...
    <div class="box-page-container flex flex-column container">
      ...
      <div class="card-body">
        <div class="row justify-content-between">
          ...
          <div class="field">
            <h4 class="font-bold">Thể loại sản phẩm</h4>
            <Dropdown v-model="selectedCity1" :options="cities" optionLabel="name" placeholder="Chọn thể loại" />
          </div>
        </div>
      </div>
          ...
          <div class="card-control">
            ...
            <div class="card-body p-5 text-center">
              <FileUpload name="demo[]" url="./upload.php" @upload="onUpload" :multiple="true" accept="image/*"
                :maxFileSize="1000000">
                <template #empty>
                  <p>Kéo thả file vào đây để tải ảnh lên.</p>
                </template>
              </FileUpload>
            </div>
          </div>
